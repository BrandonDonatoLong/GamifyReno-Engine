...
describe("test suite for accomplishments", function () {
    ...
    it("testing Accomplishment search functions", function(done){
        var accompList = new AccomplishmentList();
        var accomp1 = new Accomplishment(0, "brandonDonLong");
        accompList.addAccomplishment(accomp1);
        var accomp2 = new Accomplishment(1, "User2");
        ...
        accompList.findAccompByUser("User2", function(err, result){
            assert.ifError(err);
            if (result){
    ...
    it("testing failed search", function(done){
        var accompList = new AccomplishmentList();
        var accomp1 = new Accomplishment(0, "brandonDonLong");
        accompList.addAccomplishment(accomp1);
        var accomp2 = new Accomplishment(1, "User2");
        ...
        accompList.findAccompByUser("User3", function(err, result){
            assert.ifError(!err);
            assert.equal(err, "Cannot Find Any Accomplishments for that user");
            done()
        });
    });

    it("Testing Accomplish Search functions by objectiveid", function (done) {
        var accompList = new AccomplishmentList();
        var accomp1 = new Accomplishment(0, "brandonDonLong");
        accompList.addAccomplishment(accomp1);
